...
export default function JsonFormatPage() {
  ...
  const [json5Parser, setJson5Parser] = useState<Pick<typeof import("json5"), "parse"> | null>(
    null,
  );
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-4 mr-2 border-r border-slate-200 dark:border-slate-800 pr-4">
              <div className="flex items-center gap-2">
                ...
                <Label
                  htmlFor="json5-mode"
                  className="text-sm font-medium cursor-pointer text-slate-600 dark:text-slate-400 flex items-center gap-1.5"
                >
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-6 min-h-0">
          <AnimatePresence mode="popLayout" initial={false}>
            ...
            {(layout === "split" || layout === "output") && (
              ...
              >
                <div
                  className={`flex-1 relative overflow-auto p-6 scrollbar-thin scrollbar-thumb-stone-200 dark:scrollbar-thumb-zinc-700 ${singleColumnClass}`}
                >
                  {jsonObj ? (
                    mounted ? (
